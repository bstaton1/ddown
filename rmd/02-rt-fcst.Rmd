...
knitr::kable(tab, "latex", booktabs = T, escape = F,
             caption = "Estimates and statistics of the effects of each of the four single-variable forecast models fitted with all  $D_{50}$ and environmental data through 2018.", align = c("lccccc")) %>%
